...
Public Class ExpensesForm
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Dim frm As New NewExpenses(Me, Me.id, Me.login)
        frm.Show()
    End Sub
    ...
    Private Sub ExpensesForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        connection.Open()
        Dim cmd As New SqlCommand("select * from v_expenses ORDER BY id DESC", connection)
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        Dim expenses_id As String = DataGridView1.SelectedRows(0).Cells(0).Value.ToString()
        ...
        Dim frm As New UpdateExpenses(Me, Me.id, Me.login, expenses_id, date_val, amount, category, person)
        frm.Show()
    End Sub
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        Dim D As String
        D = MsgBox("Czy jestes pewny że chcesz usunąć ten zapis o wydatku?", vbYesNo + vbQuestion, "Pytanie")
        If D = vbYes Then
            'Delete
            connection.Open()
            Using cmd = New SqlCommand("DELETE FROM expenses WHERE id = '" & expenses_id & "' ", connection)
                cmd.ExecuteNonQuery()
            End Using
            connection.Close()
            MessageBox.Show("Wydatek został usunięty. Lista zostanie uaktualniona po odświeżeniu!", "Uwaga", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    Private Sub Form1_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Try
            If Me.WindowState = FormWindowState.Minimized Then
                Me.Visible = False
                NotifyExpensesForm.Visible = True
                NotifyExpensesForm.ShowBalloonTip(1, "BudzetDomowy", "Uruchomione ...", ToolTipIcon.Info)
                ShowInTaskbar = False
            End If
    ...
    End Sub
    Private Sub NotifyIcon1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles NotifyExpensesForm.MouseDoubleClick
        Try
            Me.Visible = True
            Me.WindowState = FormWindowState.Normal
            NotifyExpensesForm.Visible = False
            ShowInTaskbar = True
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub PictureBox6_Click(sender As Object, e As EventArgs) Handles PictureBox6.Click
        ...
        If MsgBox("Czy na pewno chcesz wygenerować nowy raport wydatków?", MsgBoxStyle.YesNo Or MsgBoxStyle.Question, "Pytanie") = MsgBoxResult.Yes Then

            Dim TitleRAP As String = "Raport wydatki"
            ...
            Dim Write As PdfWriter = PdfWriter.GetInstance(PdfFile, New FileStream(Application.StartupPath + "\raport-wydatki - " + Date.Now.ToString("ddMMyyyyHHmmss") + ".pdf", FileMode.Create))
            PdfFile.Open()
    ...
    Private Sub PictureBox7_Click(sender As Object, e As EventArgs) Handles PictureBox7.Click
        ...
        If MsgBox("Czy na pewno chcesz wygenerować nowy raport wydatkow?", MsgBoxStyle.YesNo Or MsgBoxStyle.Question, "Pytanie") = MsgBoxResult.Yes Then
            ...
            xlWorksheet.SaveAs(Application.StartupPath + "\raport-wydatki - " + Date.Now.ToString("ddMMyyyyHHmmss") + ".xlsx")
            xlApp.Quit()
